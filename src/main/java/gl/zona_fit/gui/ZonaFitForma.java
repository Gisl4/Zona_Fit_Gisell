package gl.zona_fit.gui;

import gl.zona_fit.modelo.Cliente;
import gl.zona_fit.servicio.ClienteServicio;
import gl.zona_fit.servicio.IClienteServicio;
...
public class ZonaFitForma extends JFrame{
    ...
    private void createUIComponents() {
        ...
        this.tablaModeloClientes = new DefaultTableModel(0,4){   // Evitar la edicion de valores de la BD
            @Override
    ...
    private void guardarCliente(){
        ...
        this.clienteServicio.guardarCliente(cliente); // Se inserta o modifica en la BD
    ...
    private void cargarClienteSeleccionado(){
        ...
        if (renglon != -1) {    // -1 indica que no selecciono ninguno de los registros
            var id = clientesTabla.getModel().getValueAt(renglon, 0).toString();
            this.idCliente = Integer.parseInt(id);    // Realiza la diferencia en un update o una insecion
